...
from convs.dychannel import DyChannel
...
class Block(nn.Module):
    ...
    def __init__(self, in_planes, out_planes, expansion, stride, num_experts=3, activation='sigmoid'):
        ...
        self.conv2 = DyChannel(planes, kernel_size=3, stride=stride, padding=1, groups=planes, 
...
class DyChannel_MobileNetV2(nn.Module):
    ...
    def __init__(self, num_classes=100, num_experts=3, activation='sigmoid'):
        super().__init__()
    ...
    def _make_layers(self, in_planes, num_experts, activation):
        layers = []
...
def test():
    net = DyChannel_MobileNetV2(num_classes=100)
