...
class BasicBlock(nn.Module):
    ...
    def __init__(self, in_channels, channels, stride=1, mode='A'):
        ...
        self.conv1 = DyResConv(in_channels, channels, kernel_size=3, stride=stride, padding=1, mode=mode)
        self.bn1 = nn.BatchNorm2d(channels)
        self.conv2 = DyResConv(channels, channels, kernel_size=3, stride=1, padding=1, mode=mode)
...
class DyRes_ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=1000, mode='A'):
